...
public interface Accrual extends Proratable<ProratedAccrual> {
  ...
  public abstract FeeAndRateOption getOption();
	...
	/**
	 * Split cash and PIK since ultimate sub-accruals may have different periods
	 * since PIK capitalizations always occur on a full-period basis "travel for
	 * free".
	 * 
	...
	/**
	 * The rebuild function is used to construct sub-accruals across a complex
	 * contract with inter-contract repayments. For example, we have a 10MM contract
	 * with a 1MM repayment mid-way through the contract, then the contract accrual
	 * is split into a 10MM accrual up to the repayment and a 9MM accrual from the
	 ...
	 * @param paymentDate   revised payment date, may be null
	 * 
