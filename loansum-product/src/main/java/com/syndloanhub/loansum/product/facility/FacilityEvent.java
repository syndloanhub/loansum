...
/**
 * Interface that all facility-level event classes implement.
 */
public interface FacilityEvent extends Proratable<ProratedLoanEvent> {
  /**
   * @return type of facility event, e.g. commitment adjustment
   */
