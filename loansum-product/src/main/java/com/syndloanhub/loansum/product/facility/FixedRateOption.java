 ...
 */
@BeanDefinition
public final class FixedRateOption implements FeeAndRateOption, ImmutableBean {
  ...
  public FeeAndRateOptionType getOptionType() {
    return FeeAndRateOptionType.FixedRate;
  }
  ...
  //------------------------- AUTOGENERATED START -------------------------
  /**
   * The meta-bean for {@code FixedRateOption}.
   * @return the meta-bean, not null
   */
  public static FixedRateOption.Meta meta() {
    return FixedRateOption.Meta.INSTANCE;
  }

  static {
    MetaBean.register(FixedRateOption.Meta.INSTANCE);
  }
   ...
   */
  public static FixedRateOption.Builder builder() {
    return new FixedRateOption.Builder();
  }

  private FixedRateOption(
      StandardId id,
      RateIndex index,
      LocalDate startDate,
      LocalDate endDate,
  ...
  @Override
  public FixedRateOption.Meta metaBean() {
    return FixedRateOption.Meta.INSTANCE;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      FixedRateOption other = (FixedRateOption) obj;
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<Frequency> _paymentFrequency = DirectMetaProperty.ofImmutable(
        this, "paymentFrequency", FixedRateOption.class, Frequency.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public FixedRateOption.Builder builder() {
      return new FixedRateOption.Builder();
    }

    @Override
    public Class<? extends FixedRateOption> beanType() {
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 3355:  // id
          return ((FixedRateOption) bean).getId();
        case 100346066:  // index
          return ((FixedRateOption) bean).index;
        case -2129778896:  // startDate
          return ((FixedRateOption) bean).getStartDate();
        case -1607727319:  // endDate
          return ((FixedRateOption) bean).getEndDate();
        case 3493088:  // rate
          return ((FixedRateOption) bean).getRate();
        case 696818085:  // pikSpread
          return ((FixedRateOption) bean).getPikSpread();
        case 575402001:  // currency
          return ((FixedRateOption) bean).getCurrency();
        case 1905311443:  // dayCount
          return ((FixedRateOption) bean).getDayCount();
        case 863656438:  // paymentFrequency
          return ((FixedRateOption) bean).getPaymentFrequency();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code FixedRateOption}.
   */
  public static final class Builder extends DirectFieldsBeanBuilder<FixedRateOption> {
     ...
     */
    private Builder(FixedRateOption beanToCopy) {
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(320);
      buf.append("FixedRateOption.Builder{");
