...
import com.syndloanhub.loansum.product.facility.FixedRateAccrual.Builder;
...
public final class FloatingRateAccrual implements Accrual, ImmutableBean {
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<Boolean> _payOnEndDate = DirectMetaProperty.ofImmutable(
        this, "payOnEndDate", FloatingRateAccrual.class, Boolean.TYPE);
    /**
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        ...
        case -1504004990:  // payOnEndDate
          return ((FloatingRateAccrual) bean).isPayOnEndDate();
        case -724263770:  // allInRate
