...
import com.syndloanhub.loansum.product.facility.prorated.ProratedRepayment;
 ...
 */
@BeanDefinition
public class Repayment implements LoanContractEvent, ImmutableBean {
  ...
  /**
   * Defaulted values: no interest on paydown and price is par.
   * 
   * @param builder
   */
  @ImmutableDefaults
  ...
  /**
   * Validate that repayment amount if positive.
   */
  @ImmutableValidator
  private void validate() {
    ArgChecker.notNegativeOrZero(amount.getAmount(), "repayment amount must be positive");
  }

  //------------------------- AUTOGENERATED START -------------------------
  /**
   * The meta-bean for {@code Repayment}.
   * @return the meta-bean, not null
   */
  public static Repayment.Meta meta() {
    return Repayment.Meta.INSTANCE;
  }

  static {
    MetaBean.register(Repayment.Meta.INSTANCE);
  }
   ...
   */
  public static Repayment.Builder builder() {
    return new Repayment.Builder();
  }
  ...
  public static class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<LocalDate> _effectiveDate = DirectMetaProperty.ofImmutable(
        this, "effectiveDate", Repayment.class, LocalDate.class);
    /**
    ...
    private final MetaProperty<CurrencyAmount> _amount = DirectMetaProperty.ofImmutable(
        this, "amount", Repayment.class, CurrencyAmount.class);
    /**
    ...
    @Override
    public Repayment.Builder builder() {
      return new Repayment.Builder();
    }

    @Override
    public Class<? extends Repayment> beanType() {
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -930389515:  // effectiveDate
          return ((Repayment) bean).getEffectiveDate();
        case -1413853096:  // amount
          return ((Repayment) bean).getAmount();
        case 1105799777:  // interestOnPaydown
          return ((Repayment) bean).isInterestOnPaydown();
        case 106934601:  // price
          return ((Repayment) bean).getPrice();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code Repayment}.
   */
  public static class Builder extends DirectFieldsBeanBuilder<Repayment> {
