 ...
 */
@BeanDefinition
public final class ProratedCommitmentAdjustment implements ProratedLoanEvent, ImmutableBean {
  ...
  //------------------------- AUTOGENERATED START -------------------------
  /**
   * The meta-bean for {@code ProratedCommitmentAdjustment}.
   * @return the meta-bean, not null
   */
  public static ProratedCommitmentAdjustment.Meta meta() {
    return ProratedCommitmentAdjustment.Meta.INSTANCE;
  }

  static {
    MetaBean.register(ProratedCommitmentAdjustment.Meta.INSTANCE);
  }
   ...
   */
  public static ProratedCommitmentAdjustment.Builder builder() {
    return new ProratedCommitmentAdjustment.Builder();
  }

  private ProratedCommitmentAdjustment(
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      ProratedCommitmentAdjustment other = (ProratedCommitmentAdjustment) obj;
  ...
  public String toString() {
    ...
    buf.append("ProratedCommitmentAdjustment{");
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<LocalDate> _effectiveDate = DirectMetaProperty.ofImmutable(
        this, "effectiveDate", ProratedCommitmentAdjustment.class, LocalDate.class);
    /**
    ...
    private final MetaProperty<CurrencyAmount> _amount = DirectMetaProperty.ofImmutable(
        this, "amount", ProratedCommitmentAdjustment.class, CurrencyAmount.class);
    /**
     * The meta-property for the {@code pik} property.
     */
    private final MetaProperty<Boolean> _pik = DirectMetaProperty.ofImmutable(
        this, "pik", ProratedCommitmentAdjustment.class, Boolean.TYPE);
    /**
    ...
    private final MetaProperty<Boolean> _refusalAllowed = DirectMetaProperty.ofImmutable(
        this, "refusalAllowed", ProratedCommitmentAdjustment.class, Boolean.TYPE);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public ProratedCommitmentAdjustment.Builder builder() {
      return new ProratedCommitmentAdjustment.Builder();
    }

    @Override
    public Class<? extends ProratedCommitmentAdjustment> beanType() {
      return ProratedCommitmentAdjustment.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -930389515:  // effectiveDate
          return ((ProratedCommitmentAdjustment) bean).getEffectiveDate();
        case -1413853096:  // amount
          return ((ProratedCommitmentAdjustment) bean).getAmount();
        case 110994:  // pik
          return ((ProratedCommitmentAdjustment) bean).isPik();
        case -1231792212:  // refusalAllowed
          return ((ProratedCommitmentAdjustment) bean).isRefusalAllowed();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code ProratedCommitmentAdjustment}.
   */
  public static final class Builder extends DirectFieldsBeanBuilder<ProratedCommitmentAdjustment> {
     ...
     */
    private Builder(ProratedCommitmentAdjustment beanToCopy) {
    ...
    @Override
    public ProratedCommitmentAdjustment build() {
      return new ProratedCommitmentAdjustment(
          effectiveDate,
          amount,
          pik,
          refusalAllowed);
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(160);
      buf.append("ProratedCommitmentAdjustment.Builder{");
